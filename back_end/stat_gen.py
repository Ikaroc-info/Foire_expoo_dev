...
def stat_generation(string_initiale, liste_corpus, n=2, longueur=50):
    ...
    prefix = tuple(prefix_tokens[-(n-1):]) if len(prefix_tokens) >= n-1 else random.choice(list(modele.keys()))
...
print(stat_generation("voir", ["harry_potter","bible"], n=3, longueur=50))